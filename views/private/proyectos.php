                        ...
                        <?php foreach ($proyectos as $p): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="solicitud_proyecto.php?id=<?= $p['id'] ?>" class="btn btn-sm btn-outline-info" title="Ver detalles">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="index.php?vista=registrar_proyecto_materiales&id=<?= $p['id'] ?>" class="btn btn-sm btn-outline-secondary" title="Asignar material">
