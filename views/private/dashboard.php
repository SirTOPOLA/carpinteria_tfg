      ...
      <div class="row mb-4">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <div class="progress-custom">
                  <div id="progress-bar-facturasPagadas"  class="progress-bar-custom bg-success" style="height: 8px;"></div>
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <div   class="progress-custom">
                  <div id="progress-bar-facturasPendientes"  class="progress-bar-custom bg-warning" style="height: 8px;"></div>
                </div>
              </div>
        ...
        <div class="col-lg-6 mb-4">
          <div class="card animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
            ...
            <div class="text-center mt-3">
              <a href="#" class="quick-action-btn">Ver Todos los Clientes</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card animate__animated animate__fadeInUp">
          ...
          <div class="card-body">
            <div class="alert-custom alert-danger-custom">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <small>Madera de Roble - Solo 5 unidades restantes</small>
                </div>
            ...
            <div class="alert-custom alert-warning-custom">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <strong>Pedido Próximo a Vencer</strong><br>
                  <small>Cliente: María García - Vence: 25/06/2025</small>
                </div>
            ...
            <div class="alert-custom alert-warning-custom">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <strong>Factura Pendiente</strong><br>
                  <small>Cliente: Carlos López - $2,500 - 30 días</small>
                </div>
            ...
            <div class="text-center mt-3">
              <a href="#" class="quick-action-btn">Ver Todas las Alertas</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
          ...
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="progress-custom">
                <div class="progress-bar-custom bg-success" style="--progress-width: 85%; width: 85%;"></div>
              </div>
            </div>

            <div class="mb-3">
              <div class="d-flex justify-content-between align-items-center mb-1">
                <span>Tornillos y Clavos</span>
                <span class="text-warning">45%</span>
              </div>
              <div class="progress-custom">
                <div class="progress-bar-custom bg-warning" style="--progress-width: 45%; width: 45%;"></div>
              </div>
            </div>

            <div class="mb-3">
              <div class="d-flex justify-content-between align-items-center mb-1">
                <span>Barniz y Lacas</span>
                <span class="text-info">70%</span>
              </div>
              <div class="progress-custom">
                <div class="progress-bar-custom bg-info" style="--progress-width: 70%; width: 70%;"></div>
              </div>
            </div>

            <div class="mb-3">
              <div class="d-flex justify-content-between align-items-center mb-1">
                <span>Madera de Roble</span>
                <span class="text-danger">15%</span>
              </div>
              <div class="progress-custom">
                <div class="progress-bar-custom bg-danger" style="--progress-width: 15%; width: 15%;"></div>
              </div>
            </div>

            <div class="text-center mt-3">
              <a href="#" class="quick-action-btn">Gestionar Inventario</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card animate__animated animate__fadeInUp">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-6">
                <div class="search-box">
                  ...
                  <input type="text" class="form-control" placeholder="Buscar pedidos..." id="searchPedidos">
                </div>
              </div>
            </div>
          </div>
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table table-custom mb-0" id="pedidosTable">
                <thead>
                  <tr>
                    <th>Código</th>
                    <th>Cliente</th>
                ...
                <tbody id="pedidosTableBody">
                  <tr>
                    ...
                    <td>28/06/2025</td>
                    <td>$1,200</td>
                    <td><span class="badge-custom bg-warning">En Producción</span></td>
                    <td>
                      <div class="progress-custom">
                        <div class="progress-bar-custom bg-primary" style="width: 75%;"></div>
                      </div>
                      <small class="text-muted">75%</small>
                    </td>
                    <td>
                      <button class="btn btn-sm btn-outline-primary me-1" onclick="verDetalle('PR-2024-001')">
                  ...
                  <tr>
                    ...
                    <td>María García</td>
                    <td>Estantería Personalizada</td>
                    <td>25/06/2025</td>
                    <td>$850</td>
                    <td><span class="badge-custom bg-danger">Atrasado</span></td>
                    <td>
                      <div class="progress-custom">
                    ...
                    <td>
                      <button class="btn btn-sm btn-outline-primary me-1" onclick="verDetalle('PR-2024-002')">
                        <i class="fas fa-eye"></i>
                      </button>
                      <button class="btn btn-sm btn-outline-success">
                        <i class="fas fa-edit"></i>
                  ...
                  <tr>
                    <td><strong>PR-2024-003</strong></td>
                    <td>Carlos López</td>
                    <td>Escritorio Ejecutivo</td>
                    <td>02/07/2025</td>
                    <td>$2,500</td>
                    <td><span class="badge-custom bg-success">Completado</span></td>
                    <td>
                      <div class="progress-custom">
                    ...
                    <td>
                      <button class="btn btn-sm btn-outline-primary me-1" onclick="verDetalle('PR-2024-003')">
                        <i class="fas fa-eye"></i>
                      </button>
                  ...
                  <tr>
                    <td><strong>PR-2024-004</strong></td>
                    <td>Ana Martínez</td>
                    <td>Cocina Integral</td>
                    <td>15/07/2025</td>
                    <td>$4,800</td>
                    <td><span class="badge-custom bg-info">Diseño</span></td>
                    <td>
                      <div class="progress-custom">
                        <div class="progress-bar-custom bg-info" style="width: 25%;"></div>
                      </div>
                      <small class="text-muted">25%</small>
                    </td>
                    <td>
                      <button class="btn btn-sm btn-outline-primary me-1" onclick="verDetalle('PR-2024-004')">
                        <i class="fas fa-eye"></i>
                      </button>
                      <button class="btn btn-sm btn-outline-success">
                        <i class="fas fa-edit"></i>
...
<script>
  document.addEventListener("DOMContentLoaded", () => {
    fetch('api/dashboard_data.php')
      ...
      .then(data => {
        // Ventas
        const monto = parseFloat(data.ventas_mes).toLocaleString('es-ES', { style: 'currency', currency: 'XAF' });
