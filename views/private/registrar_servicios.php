      ...
      <div class="card-body px-4 py-4">
        <form id="formServicio" method="POST" class="row g-4 needs-validation" novalidate>
          ...
          <div class="col-md-12">
            ...
            <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Ej. Corte, Pintura, Reparación" required>
          </div>
          ...
          <div class="col-md-12">
            ...
            <textarea name="descripcion" id="descripcion" class="form-control" rows="3" placeholder="Describe brevemente el servicio..."></textarea>
          </div>
          ...
          <div class="col-md-6">
            ...
            <input type="number" name="precio_base" id="precio_base" class="form-control" step="0.01" min="0" required placeholder="Ej. 50.00">
          </div>
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="unidad" id="unidad" class="form-control" required placeholder="Ej. por hora, por unidad">
          </div>
